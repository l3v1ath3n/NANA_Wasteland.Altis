...
_role4 = "Vehicles";
_role4names = [format ["Vehicles remain on the server if used at least once every 72 hours.", [A3W_vehicleMaxUnusedTime] call fn_numbersText]]];
_role5 = "Vehicles";
...
//_role7names = ["Rewards every %1 minutes for holding territories."];
