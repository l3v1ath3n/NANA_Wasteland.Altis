...
[
	// Handguns
	["P07 Pistol", "hgun_P07_F", 300],
	["Rook-40 Pistol", "hgun_Rook40_F", 325],
	["ACP-C2 Pistol", "hgun_ACPC2_F", 350],
	["Zubr Revolver", "hgun_Pistol_heavy_02_F", 400],
	["4-Five Pistol", "hgun_Pistol_heavy_01_F", 600]
];
...
[
	...
	["Mk20 Carbine (Camo)", "arifle_Mk20C_F", 800],
	["Mk20 Rifle", "arifle_Mk20_plain_F", 800],
	["Mk20 Rifle (Camo)", "arifle_Mk20_F", 800],
	["Mk20 EGLM Rifle", "arifle_Mk20_GL_plain_F", 800],
	["Mk20 EGLM Rifle (Camo)", "arifle_Mk20_GL_F", 800],

	["TRG-20 Carbine", "arifle_TRG20_F", 850],
	["TRG-21 Rifle ", "arifle_TRG21_F", 850],
	["TRG-21 EGLM Rifle", "arifle_TRG21_GL_F", 850],

	["Katiba Carbine", "arifle_Katiba_C_F", 850],
	["Katiba Rifle", "arifle_Katiba_F", 850],
	["Katiba GL Rifle", "arifle_Katiba_GL_F", 850],

	["MX Carbine", "arifle_MXC_F", 500],
	["MX Carbine (Black)", "arifle_MXC_Black_F", 650],
	["MX Rifle", "arifle_MX_F", 900],
	["MX Rifle (Black)", "arifle_MX_Black_F", 900],
...
[
	["MX SW LMG", "arifle_MX_SW_F", 950],
	["MX SW LMG (Black)", "arifle_MX_SW_Black_F", 950],
	["Mk200 LMG", "LMG_Mk200_F", 1250],
	["Zafir LMG", "LMG_Zafir_F", 1750]
];
...
[
	...
	["9mm 30Rnd Mag", "30Rnd_9x21_Mag", 60],
	[".45 ACP 6Rnd Cylinder", "6Rnd_45ACP_Cylinder", 25],
	[".45 ACP 9Rnd Mag", "9Rnd_45ACP_Mag", 35],
	[".45 ACP 11Rnd Mag", "11Rnd_45ACP_Mag", 45],
	[".45 ACP 30Rnd Vermin Mag", "30Rnd_45ACP_MAG_SMG_01", 75],
	[".45 ACP 30Rnd Tracer (Green) Mag", "30Rnd_45ACP_Mag_SMG_01_tracer_green", 75],
	["5.56mm 20Rnd Underwater Mag", "20Rnd_556x45_UW_mag", 40],
...
[
	["Suppressor 9mm", "muzzle_snds_L", 400, "item"],
	["Suppressor .45 ACP", "muzzle_snds_acp", 400, "item"],
	["Suppressor 5.56mm", "muzzle_snds_M", 500, "item"],
	["Suppressor 6.5mm", "muzzle_snds_H", 600, "item"],
	["Suppressor 6.5mm LMG", "muzzle_snds_H_MG", 750, "item"],
	["Suppressor 7.62mm", "muzzle_snds_B", 800, "item"],
	["Flashlight", "acc_flashlight", 150, "item"],
	["IR Laser Pointer", "acc_pointer_IR", 300, "item"],
	...
	["MRCO", "optic_MRCO", 425, "item"],
	["ARCO", "optic_Arco", 425, "item"],
	["RCO", "optic_Hamr", 450, "item"],
	["DMS", "optic_DMS", 800, "item"],
	["LRPS", "optic_LRPS", 1200, "item"],
	["SOS", "optic_SOS", 800, "item"],
	["NVS", "optic_NVS", 800, "item"],
...
[
	["ECH", "H_HelmetB", 300, "hat"],
	["ECH (Ghillie)", "H_HelmetB_camo", 500, "hat"],
	["ECH (Light)", "H_HelmetB_light", 400, "hat"],
	["ECH (Spraypaint)", "H_HelmetB_paint", 400, "hat"],
	["SF Helmet", "H_HelmetSpecB", 350, "hat"],
	["SF Helmet (Black)", "H_HelmetSpecB_blk", 350, "hat"],
	["SF Helmet (Light Paint)", "H_HelmetSpecB_paint1", 350, "hat"],
	["SF Helmet (Dark Paint)", "H_HelmetSpecB_paint2", 350, "hat"],
	["Combat Helmet (Black)", "H_HelmetB_plain_blk", 300, "hat"],
	["Protector Helmet (Hex)", "H_HelmetO_ocamo", 300, "hat"],
	...
	// ["Assassin Helmet (Hex)", "H_HelmetSpecO_ocamo", 850, "hat"],
	["Assassin Helmet (Black)", "H_HelmetSpecO_blk", 850, "hat"],
	["MICH", "H_HelmetIA", 500, "hat"],
	// ["MICH (Camo)", "H_HelmetIA_net", 500, "hat"],
	// ["MICH 2 (Camo)", "H_HelmetIA_camo", 500, "hat"],
	["Heli Crew Helmet (NATO)", "H_CrewHelmetHeli_B", 750, "hat"],
	["Heli Crew Helmet (CSAT)", "H_CrewHelmetHeli_O", 750, "hat"],
	["Heli Crew Helmet (AAF)", "H_CrewHelmetHeli_I", 750, "hat"],
	["Heli Pilot Helmet (NATO)", "H_PilotHelmetHeli_B", 750, "hat"],
	["Heli Pilot Helmet (CSAT)", "H_PilotHelmetHeli_O", 750, "hat"],
	["Heli Pilot Helmet (AAF)", "H_PilotHelmetHeli_I", 750, "hat"],
	["Crew Helmet (NATO)", "H_HelmetCrew_B", 600, "hat"],
	["Crew Helmet (CSAT)", "H_HelmetCrew_O", 600, "hat"],
	["Crew Helmet (AAF)", "H_HelmetCrew_I", 600, "hat"],
	["Pilot Helmet (NATO)", "H_PilotHelmetFighter_B", 950, "hat"],
	["Pilot Helmet (CSAT)", "H_PilotHelmetFighter_O", 950, "hat"],
	["Pilot Helmet (AAF)", "H_PilotHelmetFighter_I", 950, "hat"],
...
[
	["Ghillie Suit (NATO)", "U_B_GhillieSuit", 650, "uni"],
	["Ghillie Suit (CSAT)", "U_O_GhillieSuit", 650, "uni"],
	["Ghillie Suit (AAF)", "U_I_GhillieSuit", 650, "uni"],
	...
	["Pilot Coveralls (NATO)", "U_B_PilotCoveralls", 450, "uni"],
	["Pilot Coveralls (CSAT)", "U_O_PilotCoveralls", 450, "uni"],
	["Pilot Coveralls (AAF)", "U_I_pilotCoveralls", 450, "uni"],
	["Heli Pilot Coveralls (NATO)", "U_B_HeliPilotCoveralls", 450, "uni"],
	["Heli Pilot Coveralls (AAF)", "U_I_HeliPilotCoveralls", 450, "uni"],
...
[
	...
	["Carrier Lite (Green)", "V_PlateCarrier1_rgr", 600, "vest"],
	["Carrier Lite (Black)", "V_PlateCarrier1_blk", 600, "vest"],
	["Carrier Rig (Green)", "V_PlateCarrier3_rgr", 700, "vest"],
	["Carrier GL Rig (Green)", "V_PlateCarrierGL_rgr", 700, "vest"],
	["GA Carrier Lite (Digi)", "V_PlateCarrierIA1_dgtl", 700, "vest"],
	["GA Carrier Rig (Digi)", "V_PlateCarrierIA2_dgtl", 700, "vest"],
	["GA Carrier GL Rig (Digi)", "V_PlateCarrierIAGL_dgtl", 900, "vest"],
	["LBV Harness", "V_HarnessO_brn", 700, "vest"],
	["LBV Harness (Gray)", "V_HarnessO_gry", 700, "vest"],
	["LBV Grenadier Harness", "V_HarnessOGL_brn", 700, "vest"],
	["LBV Grenadier Harness (Gray)", "V_HarnessOGL_gry", 700, "vest"],
	["ELBV Harness", "V_HarnessOSpec_brn", 700, "vest"],
	["ELBV Harness (Gray)", "V_HarnessOSpec_gry", 700, "vest"],
	["Slash Bandolier (Black)", "V_BandollierB_blk", 600, "vest"],
	["Slash Bandolier (Coyote)", "V_BandollierB_cbr",600, "vest"],
	["Slash Bandolier (Green)", "V_BandollierB_rgr", 600, "vest"],
	["Slash Bandolier (Khaki)", "V_BandollierB_khk", 600, "vest"],
	["Slash Bandolier (Olive)", "V_BandollierB_oli", 600, "vest"],
	["Chest Rig (Khaki)", "V_Chestrig_khk", 600, "vest"],
	["Chest Rig (Green)", "V_Chestrig_rgr", 600, "vest"],
	["Fighter Chestrig (Black)", "V_Chestrig_blk", 600, "vest"],
	["Fighter Chestrig (Olive)", "V_Chestrig_oli", 600, "vest"],
	["Tactical Vest (Black)", "V_TacVest_blk", 600, "vest"],
	["Tactical Vest (Brown)", "V_TacVest_brn", 600, "vest"],
	["Tactical Vest (Camo)", "V_TacVest_camo", 600, "vest"],
	["Tactical Vest (Khaki)", "V_TacVest_khk", 600, "vest"],
	["Tactical Vest (Olive)", "V_TacVest_oli", 600, "vest"],
	["Raven Night Vest", "V_TacVestIR_blk", 800, "vest"]
];
...
[
	["Empty Ammo Crate", "Box_NATO_Ammo_F", 800, "ammocrate"],
	//["Metal Barrel", "Land_MetalBarrel_F", 150, "object"],
	//["Toilet Box", "Land_ToiletBox_F", 125, "object"],
	["Lamp Post (Harbour)", "Land_LampHarbour_F", 400, "object"],
	["Lamp Post (Shabby)", "Land_LampShabby_F", 300, "object"],
	["Boom Gate", "Land_BarGate_F", 700, "object"],
	["Pipes", "Land_Pipes_Large_F", 200, "object"],
	["Concrete Frame", "Land_CncShelter_F", 600, "object"],
	["Highway Guardrail", "Land_Crash_barrier_F", 200, "object"],
	["Concrete Barrier", "Land_CncBarrier_F", 600, "object"],
	["Concrete Barrier (Medium)", "Land_CncBarrierMedium_F", 650, "object"],
	["Concrete Barrier (Long)", "Land_CncBarrierMedium4_F", 850, "object"],
	["HBarrier (1 block)", "Land_HBarrier_1_F", 750, "object"],
	["HBarrier (3 blocks)", "Land_HBarrier_3_F", 2250, "object"],
	["HBarrier (5 blocks)", "Land_HBarrier_5_F", 3750, "object"],
	["HBarrier Big", "Land_HBarrierBig_F", 1000, "object"],
	["HBarrier Wall (4 blocks)", "Land_HBarrierWall4_F", 750, "object"],
	["HBarrier Wall (6 blocks)", "Land_HBarrierWall6_F", 750, "object"],
	["HBarrier Watchtower", "Land_HBarrierTower_F", 20000, "object"],
	["Concrete Wall", "Land_CncWall1_F", 400, "object"],
	["Concrete Military Wall", "Land_Mil_ConcreteWall_F", 1000, "object"],
	["Concrete Wall (Long)", "Land_CncWall4_F", 1300, "object"],
	["Military Wall (Big)", "Land_Mil_WallBig_4m_F", 4000, "object"],
	//["Shoot House Wall", "Land_Shoot_House_Wall_F", 1000, "object"],
	["Canal Wall (Small)", "Land_Canal_WallSmall_10m_F", 800, "object"],
	["Canal Stairs", "Land_Canal_Wall_Stairs_F", 800, "object"],
	["Bag Fence (Corner)", "Land_BagFence_Corner_F", 350, "object"],
	["Bag Fence (End)", "Land_BagFence_End_F", 350, "object"],
	["Bag Fence (Long)", "Land_BagFence_Long_F", 350, "object"],
	["Bag Fence (Round)", "Land_BagFence_Round_F", 350, "object"],
	["Bag Fence (Short)", "Land_BagFence_Short_F", 350, "object"],
	["Bag Bunker (Small)", "Land_BagBunker_Small_F", 2000, "object"],
	["Bag Bunker (Large)", "Land_BagBunker_Large_F", 6000, "object"],
	["Bag Bunker Tower", "Land_BagBunker_Tower_F", 9000, "object"],
	["Military Cargo Post", "Land_Cargo_Patrol_V1_F", 50000, "object"],
	["Military Cargo Tower", "Land_Cargo_Tower_V1_F", 750000, "object"],
	["Concrete Ramp", "Land_RampConcrete_F", 350, "object"],
	["Concrete Ramp (High)", "Land_RampConcreteHigh_F", 500, "object"],
	["Scaffolding", "Land_Scaffolding_F", 550, "object"]
];
...
[
	...
	["Quadbike (NATO)", "B_Quadbike_01_F", 800, "vehicle"],
	["Quadbike (CSAT)", "O_Quadbike_01_F", 800, "vehicle"],
	["Quadbike (AAF)", "I_Quadbike_01_F", 800, "vehicle"],
	["Quadbike (FIA)", "B_G_Quadbike_01_F", 800, "vehicle"],

	["Hatchback", "C_Hatchback_01_F", 1000, "vehicle"],
	["Hatchback Sport", "C_Hatchback_01_sport_F", 1000, "vehicle"],
	["SUV", "C_SUV_01_F", 1200, "vehicle"],
	["Offroad", "C_Offroad_01_F", 1500, "vehicle"],
	["Offroad Camo", "B_G_Offroad_01_F", 1600, "vehicle"],
	["Offroad Repair", "C_Offroad_01_repair_F", 1600, "vehicle"],
	["Offroad HMG", "B_G_Offroad_01_armed_F", 2500, "vehicle"],

	["Truck", "C_Van_01_transport_F", 1000, "vehicle"],
	["Truck (Camo)", "B_G_Van_01_transport_F", 800, "vehicle"],
	["Truck Box", "C_Van_01_box_F", 1000, "vehicle"],
	...
	["HEMTT Repair", "B_Truck_01_Repair_F", 18000, "vehicle"],
	...
	["Zamak Repair", "I_Truck_02_box_F", 12500, "vehicle"],
	["Zamak Ammo", "I_Truck_02_ammo_F", 27500, "vehicle"],
...
[
	...
	["Mi-290 Taru (Crane) [DLC] !LIFT!", "O_Heli_Transport_04_F", 7500, "vehicle"], // CH-54
	...
	["CH-49 Mohawk !LIFT!", "I_Heli_Transport_02_F", 10000, "vehicle"], // AW101
	...
	["CH-67 Huron (Armed) [DLC] !LIFT!", "B_Heli_Transport_03_F", 30000, "vehicle"], // CH-47 with 2 side miniguns
...
[
	...
	["SDV Submarine (NATO)", "B_SDV_01_F", 100000, "submarine"],
	["SDV Submarine (CSAT)", "O_SDV_01_F", 100000, "submarine"],
	["SDV Submarine (AAF)", "I_SDV_01_F", 100000, "submarine"]
];
